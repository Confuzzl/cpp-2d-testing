...
SET_UNIFORM_F(Basic, FragColor, color_t &, frag_color)
...
SET_UNIFORM_F(Transform, FragColor, color_t &, frag_color)
...
SET_UNIFORM_F(Striped, FragColor, color_t &, frag_color)

SET_UNIFORM_G(Line, View, glm::mat4 &, view)
SET_UNIFORM_G(Line, Thickness, float, thickness)
SET_UNIFORM_F(Line, FragColor, color_t &, frag_color)
...
SET_UNIFORM_F(Circle, FragColor, color_t &, frag_color)